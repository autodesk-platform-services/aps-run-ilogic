...
More details here: [Quick tests using iLogic](https://aps.autodesk.com/blog/quick-tests-using-ilogic)
...
To use this sample, you will need Autodesk developer credentials. Visit the [APS Developer Portal](https://developer.autodesk.com), sign up for an account, then [create an app](https://developer.autodesk.com/myapps/create). Finally, take note of the **Client ID** and **Client Secret**.
